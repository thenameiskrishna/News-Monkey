    ...
    return (
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route exact path="/entertainment" element={<News key="entertainmen" pageSize={5} country="in" category="entertainment"/>}></Route>
          ...
          <Route exact path="/technology" element={<News key="technology" pageSize={5} country="in" category="technology"/>}></Route></Routes>
